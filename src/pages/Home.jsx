  ...
  return (
    <div className="p-4 flex-1">
      ...
      <div className="grid gap-4">
        <Link to="/workout" className="p-4 bg-white rounded shadow flex items-center justify-between">
          <div>
        ...
        <Link to="/progress" className="p-4 bg-white rounded shadow flex items-center justify-between">
          <div>
        ...
        <Link to="/profile" className="p-4 bg-white rounded shadow flex items-center justify-between">
          <div>
